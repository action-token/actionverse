  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back Side - Message */}
        <div
          className="absolute inset-0 flex aspect-[4/3] items-center justify-center rounded-2xl bg-gradient-to-br from-primary/10 via-card to-secondary p-8 md:p-16 ring-1 ring-border"
          style={{
