  ...
  return (
    ...
    >
      <Card className="group relative overflow-hidden rounded-xl  transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
        <CardContent className="h-[211px] w-full p-0 md:h-[270px] lg:h-[300px]">
          <div className="relative h-full w-full">
            ...
            <div className="absolute inset-x-0 bottom-1 left-1 right-1 rounded-xl border-2 p-0">
              <div className="rounded-lg bg-black/10 p-2 backdrop-blur-sm">
                <p className="mb-2 truncate text-lg font-bold text-white">
                  {code}
                </p>
