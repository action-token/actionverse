...
export default function PaymentCardDialog({ isOpen, setIsOpen, offer, pubkey, xdr }: PaymentCardDialogDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Securely pay for your tokens using your credit or debit card.</DialogDescription>
        </DialogHeader>
          ...
          {status === "idle" && (
            <div className="space-y-4">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full mt-4 bg-primary hover:bg-primary/90 text-primary-foreground py-3 px-4 rounded-md font-medium transition-colors"
                  disabled={loading}
                >
                  Pay ${offer.price}
                </button>
          ...
          {status === "error" && (
            ...
            >
              ...
              <button
                ...
                className="px-4 py-2 bg-muted hover:bg-muted/80 rounded-md font-medium transition-colors"
              >
                Try Again
              </button>
            </motion.div>
