...
import {
    ChevronDown, Loader2, Users, Award, CheckCheck,
    Heart, MessageSquare, UserPlus, Trophy, MessagesSquare,
    FileText, Send, SmilePlus
} from "lucide-react"
...
const CreatorNotifications = () => {
    ...
    const markAllSeen = api.fan.notification.markAllAsSeen.useMutation({
        onSuccess: () => {
            void utils.fan.notification.getCreatorNotifications.invalidate()
    ...
    const allNotifications = (notifications.data?.pages.flatMap((page) => page.items) ?? []) as NotificationItem[]
            ...
            <div className="p-6">
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Updates from your fans and followers</p>
                        </div>
                        {unseenCount > 0 && (
                            <motion.div
                                initial={{ scale: 0 }}
                    ...
                    {unseenCount > 0 && (
                        <Button
                            ...
                            onClick={() => markAllSeen.mutate({ isCreator: true })}
                ...
                {notifications.isLoading ? (
                    ...
                    >
                        ...
                        <h3 className="text-xl font-medium">No creator notifications yet</h3>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        {notification.notificationObject.entityType === NotificationType.BOUNTY_SUBMISSION && (
                                                            <Badge variant="outline" className="ml-auto shrink-0 bg-amber-50 text-amber-700 border-amber-200 text-[10px]">
                                                                Review
                                                            </Badge>
                                                        )}
                                                    </motion.div>
