          ...
          <div className="mx-auto max-w-3xl px-4 py-5 md:px-6">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {community.isTokenGated &&
                  ...
                  community.requiredBalanceIssuer && (
                    ...
                    >
                      <Badge className="gap-1 border-0 bg-amber-500/90 text-xs font-normal text-white hover:bg-amber-600">
                        <Shield className="h-3 w-3" />
                        {community.requiredBalance}{" "}
                        {community.requiredBalanceCode} required
            ...
            {canPost && (
              <button
                ...
                className="mt-5 flex w-full items-center gap-3 rounded-xl border bg-card p-4 text-left transition-colors hover:bg-muted/50"
              >
            ...
            <div className="mt-5 space-y-4 pb-8">
              {isPostsLocked ? (
                <LockedContent
                  requiredBalance={community.requiredBalance}
                  requiredBalanceCode={community.requiredBalanceCode}
                />
              ) : posts.isLoading ? (
