...
export default function OrganizationEditBountyPage() {
  ...
  useEffect(() => {
    if (bounty && session?.user && !isCreator) void router.push(`/bounty/${id}`);
  }, [bounty, session, isCreator, router, id]);
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <nav className="flex items-center gap-1.5 text-xs text-muted-foreground mb-4">
            <Link href="/organization/bounty" className="hover:text-foreground transition-colors">
              My Bounties
            </Link>
