...
import { ArrowLeft, Box, Calendar, FileText, AlertCircle, RotateCcw, Navigation, MapPin, Eye, EyeOff, Plus, Minus } from 'lucide-react';
                    ...
                    <Card className="bg-black/90 text-white border-gray-700">
                        <CardHeader>
                            ...
                            <CardDescription className="text-gray-300">
                                Created by {qrItem.creator.name ?? "Unknown"}
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 text-sm">
                                ...
                                <span className="text-blue-400 font-medium">
                                    {distanceToModel.toFixed(1)} meters away
                                </span>
                            </div>
                            ...
                            {debugMode && modelPosition && (
                                <div className="bg-red-900/30 border border-red-700 rounded p-2 text-xs">
                                    ...
                                    <div>Model Position: {modelPosition.lat.toFixed(6)}, {modelPosition.lng.toFixed(6)}</div>
                                    {currentPosition && (
                                        <div>Your Position: {currentPosition.lat.toFixed(6)}, {currentPosition.lng.toFixed(6)}</div>
                                    )}
                            ...
                            <div className="flex items-center gap-2 text-xs text-gray-400">
                                ...
                                <span>
                                    {format(new Date(qrItem.startDate), "MMM dd, yyyy")} - {format(new Date(qrItem.endDate), "MMM dd, yyyy")}
                                </span>
                            </div>
