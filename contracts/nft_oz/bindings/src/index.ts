...
export const networks = {
  testnet: {
    ...
    contractId: "CD3LMEHJG2AA5IZDGQB6O6HL2XPKU5WMXEGPRV25JY4Q4K2EBRK26N4S",
  }
} as const
...
export interface Client {
   ...
   */
  is_unlocked: ({token_id}: {token_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
  ...
  /**
   * Construct and simulate a unlock_token_for transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   * later.
   */
  unlock_token_for: ({caller, token_id}: {caller: string, token_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAABkxpc3RlZAAAAAAAAQAAAAZsaXN0ZWQAAAAAAAMAAAAAAAAACHRva2VuX2lkAAAABAAAAAEAAAAAAAAABnNlbGxlcgAAAAAAEwAAAAEAAAAAAAAABnByaWNlcwAAAAAD6gAAB9AAAAAKUHJpY2VFbnRyeQAAAAAAAAAAAAI=",
        ...
        "AAAABQAAAAAAAAAAAAAAD0NvbnRlbnRVbmxvY2tlZAAAAAABAAAAEGNvbnRlbnRfdW5sb2NrZWQAAAACAAAAAAAAAAh0b2tlbl9pZAAAAAQAAAABAAAAAAAAAAVvd25lcgAAAAAAABMAAAABAAAAAg==",
        ...
        "",
        ...
        "",
  ...
  public readonly fromJSON = {
    buy: this.txFromJSON<null>,
        ...
        is_unlocked: this.txFromJSON<boolean>,
        ...
        unlock_token_for: this.txFromJSON<null>,
