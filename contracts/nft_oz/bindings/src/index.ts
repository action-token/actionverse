...
export interface Client {
  ...
  /**
   * Construct and simulate a inclusion_fee transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  inclusion_fee: ({payment_token}: {payment_token: string}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>
  ...
  /**
   * Construct and simulate a set_inclusion_fee transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  set_inclusion_fee: ({payment_token, fee}: {payment_token: string, fee: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAABkxpc3RlZAAAAAAAAQAAAAZsaXN0ZWQAAAAAAAMAAAAAAAAACHRva2VuX2lkAAAABAAAAAEAAAAAAAAABnNlbGxlcgAAAAAAEwAAAAEAAAAAAAAABnByaWNlcwAAAAAD6gAAB9AAAAAKUHJpY2VFbnRyeQAAAAAAAAAAAAI=",
        ...
        "",
        ...
        "AAAABQAAAAAAAAAAAAAAE0luY2x1c2lvbkZlZVVwZGF0ZWQAAAAAAQAAABVpbmNsdXNpb25fZmVlX3VwZGF0ZWQAAAAAAAACAAAAAAAAAA1wYXltZW50X3Rva2VuAAAAAAAAEwAAAAEAAAAAAAAAA2ZlZQAAAAALAAAAAAAAAAI=",
        ...
        "AAAAAAAAAAAAAAANaW5jbHVzaW9uX2ZlZQAAAAAAAAEAAAAAAAAADXBheW1lbnRfdG9rZW4AAAAAAAATAAAAAQAAAAs=",
        ...
        "",
  ...
  public readonly fromJSON = {
    buy: this.txFromJSON<null>,
        ...
        inclusion_fee: this.txFromJSON<i128>,
        ...
        set_inclusion_fee: this.txFromJSON<null>,
